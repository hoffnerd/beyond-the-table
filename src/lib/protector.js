...
export const pageProtector = async (config) => {
    ...
    if (!session) {
        if (config && config.redirectDestination && config.redirectDestination.notLoggedIn) {
        ...
        if (config && config.redirectDestination && config.redirectDestination.notAuthorized) {
