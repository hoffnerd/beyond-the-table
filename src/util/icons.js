...
// Icons ----------------------------------------------------------------------------
import { faCheck, faArrowLeft, faDungeon, faUser, faUsers, faUserPlus, faUserPen, faImage, faArrowUpShortWide, faArrowDownWideShort, faTrashCan, faHandFist, faShoePrints, faShieldHeart, faBook, faScroll, faCommentDots, faDice, faMobileButton, faIdBadge } from '@fortawesome/free-solid-svg-icons';
const library = { faCheck, faArrowLeft, faDungeon, faUser, faUsers, faUserPlus, faUserPen, faImage, faArrowUpShortWide, faArrowDownWideShort, faTrashCan, faHandFist, faShoePrints, faShieldHeart, faBook, faScroll, faCommentDots, faDice, faMobileButton, faIdBadge };
